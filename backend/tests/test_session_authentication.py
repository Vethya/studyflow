...
class SessionAuthenticationRepositoryStub:
    ...
    authentication_calls: list[tuple[str, datetime, datetime]]
    ...
    async def authenticate(
        ...
        self.authentication_calls.append((token_hash, now, refreshed_idle_expiry))
...
async def test_session_authentication_hashes_credentials_and_refreshes_idle_expiry() -> None:
    ...
    token_hash, called_at, idle_expiry = repository.authentication_calls[0]
